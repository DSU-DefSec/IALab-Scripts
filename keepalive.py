...
resp = requests.put("https://vcloud.ialab.dsu.edu/api/vApp/{}/leaseSettingsSection/".format(vapp_id), json={
    "deploymentLeaseInSeconds": "172800", "storageLeaseInSeconds": "0", "_type": "LeaseSettingsSectionType"}, headers={
    "Content-Type": "application/*+json", "Accept": "application/*+json;version=35.2;", "x-vcloud-authorization": auth})
